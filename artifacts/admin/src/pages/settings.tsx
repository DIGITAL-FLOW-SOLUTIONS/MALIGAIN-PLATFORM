          ...
          <div className={sectionCard}>
            ...
            <div className="p-6 space-y-6">
              <div className="space-y-3">
                ...
                <div>
                  <label className={labelCls}>Business Name</label>
                  <input type="text" value={mtnBusinessName} onChange={(e) => setMtnBusinessName(e.target.value)} placeholder="e.g. MALIGAIN" className={inputCls} />
              ...
              <div className="border-t border-border pt-5 space-y-3">
                ...
                <div>
                  <label className={labelCls}>Business Name</label>
                  <input type="text" value={airtelBusinessName} onChange={(e) => setAirtelBusinessName(e.target.value)} placeholder="e.g. MALIGAIN" className={inputCls} />
                  <p className={subLabelCls}>Displayed in the "CONFIRM it is..." step</p>
                </div>
              </div>
              <div className="border-t border-border pt-5 space-y-3">
