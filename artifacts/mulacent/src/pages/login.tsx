    ...
    <div className="min-h-screen flex" style={{ background: "#f0f4ff" }}>
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-xs">
          ...
          <h1 className="text-white font-black tracking-widest mb-2" style={{ fontSize: 32, letterSpacing: "0.12em" }}>MALIGAIN</h1>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          ...
          <div className="flex lg:hidden items-center gap-3 mb-7 justify-center">
            ...
            <div>
              <h1 className="font-black tracking-widest text-slate-800" style={{ fontSize: 22, letterSpacing: "0.1em" }}>MALIGAIN</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" autoComplete="on">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="/forgot-password" className="text-blue-500 text-xs hover:text-blue-600 transition-colors font-medium">Forgot password?</Link>
                </div>
