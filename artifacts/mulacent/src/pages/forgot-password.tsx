          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
            {sent ? (
              <div className="text-center py-4">
                ...
                <h2 className="text-slate-800 font-bold text-xl mb-2">Check Your Email</h2>
                <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                  If <strong className="text-slate-700">{email}</strong> is registered, we've sent password reset instructions.
                  <br /><br />
                  The link expires after 1 hour. Didn't receive it? Check your spam folder.
                </p>
                <Link
                  href="/login"
                  className="inline-flex items-center gap-2 text-blue-500 hover:text-blue-600 text-sm font-semibold transition-colors"
                >
              ...
              <>
                <div className="mb-6">
                  ...
                  <h2 className="text-slate-800 font-bold text-xl mb-1">Reset Password</h2>
